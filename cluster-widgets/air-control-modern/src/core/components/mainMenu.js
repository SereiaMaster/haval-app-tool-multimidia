...
const iconPalette = `data:image/svg+xml;base64,${btoa('<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none"><circle cx="14" cy="18" r="8" fill="#3b82f6"/><circle cx="34" cy="18" r="8" fill="#eab308"/><circle cx="14" cy="32" r="8" fill="#ef4444"/><circle cx="34" cy="32" r="8" fill="#f97316"/></svg>')}`;
...
export const menuItems = [
    ...
    { id: 'option_8', label: 'Cores', iconSrc: iconPalette },
];
